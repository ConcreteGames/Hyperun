...
declare class SteamNetConnection extends IpConnection { 
	...
	static C(Other: UObject): SteamNetConnection;
}
...
declare class SteamNetDriver extends IpNetDriver { 
	...
	static C(Other: UObject): SteamNetDriver;
}
...
declare type ELowEntryBatteryState = string | symbol;
...
declare type ELowEntryImageFormat = string | symbol;
...
declare class AnalyticsEventAttr { 
	Name: string;
	Value: string;
	clone() : AnalyticsEventAttr;
	static C(Other: UObject): AnalyticsEventAttr;
	static MakeEventAttribute(AttributeName: string,AttributeValue: string): AnalyticsEventAttr;
}

declare class AnalyticsBlueprintLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AnalyticsBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): AnalyticsBlueprintLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AnalyticsBlueprintLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AnalyticsBlueprintLibrary;
	static StartSessionWithAttributes(Attributes: AnalyticsEventAttr[]): boolean;
	static StartSession(): boolean;
	static SetUserId(UserId: string): void;
	static SetSessionId(SessionId: string): void;
	static SetLocation(Location: string): void;
	static SetGender(Gender: string): void;
	static SetBuildInfo(BuildInfo: string): void;
	static SetAge(Age: number): void;
	static RecordSimpleItemPurchaseWithAttributes(ItemId: string,ItemQuantity: number,Attributes: AnalyticsEventAttr[]): void;
	static RecordSimpleItemPurchase(ItemId: string,ItemQuantity: number): void;
	static RecordSimpleCurrencyPurchaseWithAttributes(GameCurrencyType: string,GameCurrencyAmount: number,Attributes: AnalyticsEventAttr[]): void;
	static RecordSimpleCurrencyPurchase(GameCurrencyType: string,GameCurrencyAmount: number): void;
	static RecordProgressWithFullHierarchyAndAttributes(ProgressType: string,ProgressNames: string[],Attributes: AnalyticsEventAttr[]): void;
	static RecordProgressWithAttributes(ProgressType: string,ProgressName: string,Attributes: AnalyticsEventAttr[]): void;
	static RecordProgress(ProgressType: string,ProgressName: string): void;
	static RecordItemPurchase(ItemId: string,Currency: string,PerItemCost: number,ItemQuantity: number): void;
	static RecordEventWithAttributes(EventName: string,Attributes: AnalyticsEventAttr[]): void;
	static RecordEventWithAttribute(EventName: string,AttributeName: string,AttributeValue: string): void;
	static RecordEvent(EventName: string): void;
	static RecordErrorWithAttributes(Error: string,Attributes: AnalyticsEventAttr[]): void;
	static RecordError(Error: string): void;
	static RecordCurrencyPurchase(GameCurrencyType: string,GameCurrencyAmount: number,RealCurrencyType: string,RealMoneyCost: number,PaymentProvider: string): void;
	static RecordCurrencyGivenWithAttributes(GameCurrencyType: string,GameCurrencyAmount: number,Attributes: AnalyticsEventAttr[]): void;
	static RecordCurrencyGiven(GameCurrencyType: string,GameCurrencyAmount: number): void;
	static MakeEventAttribute(AttributeName: string,AttributeValue: string): AnalyticsEventAttr;
	static GetUserId(): string;
	static GetSessionId(): string;
	static FlushEvents(): void;
	static EndSession(): void;
	static C(Other: UObject): AnalyticsBlueprintLibrary;
}

declare class AdvancedSteam extends UObject { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteam;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteam;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteam;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteam;
	static C(Other: UObject): AdvancedSteam;
}

declare type EAdvancedSteamErrorCode = string | symbol;
declare var EAdvancedSteamErrorCode = { UNKNOWN:'UNKNOWN',ADVANCED_STEAM_MODULE_NOT_INITIALIZED:'ADVANCED_STEAM_MODULE_NOT_INITIALIZED',STEAM_NOT_INITIALIZED:'STEAM_NOT_INITIALIZED',STEAM_STATS_INVALID:'STEAM_STATS_INVALID',STEAM_STATS_STORE_FAILED:'STEAM_STATS_STORE_FAILED',VALUE_NOT_EXIST:'VALUE_NOT_EXIST',UNSUPPORTED_TYPE:'UNSUPPORTED_TYPE',INVALID_GAMEID:'INVALID_GAMEID',INVALID_PLAYER_ID:'INVALID_PLAYER_ID',INVALID_PLAYER_STATE:'INVALID_PLAYER_STATE',FILE_NOT_FOUND:'FILE_NOT_FOUND',FAILED_TO_SAVE_REPLAY:'FAILED_TO_SAVE_REPLAY',EXTERAL_WEBUI_OPEN_FAILED:'EXTERAL_WEBUI_OPEN_FAILED',FAILED_TO_WRITE_FILE:'FAILED_TO_WRITE_FILE',FAILED_TO_READ_FILE:'FAILED_TO_READ_FILE',FAILED_TO_SAVE_FILE:'FAILED_TO_SAVE_FILE',FAILED_TO_DELETE_FILE:'FAILED_TO_DELETE_FILE', };
declare class AdvancedSteamAchievementClearCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamAchievementClearCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamAchievementClearCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamAchievementClearCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamAchievementClearCallbackProxy;
	static ClearSteamAchievement(AchievementId: string): AdvancedSteamAchievementClearCallbackProxy;
	static C(Other: UObject): AdvancedSteamAchievementClearCallbackProxy;
}

declare type EStatsType = string | symbol;
declare var EStatsType = { Int32:'Int32',Float:'Float', };
declare class SteamStats { 
	KeyName: string;
	StatsType: EStatsType;
	FloatValue: number;
	Int32Value: number;
	clone() : SteamStats;
	static C(Other: UObject): SteamStats;
}

declare class SteamAchievements { 
	AchievementId: string;
	IsProgressAchievement: boolean;
	StatInfo: SteamStats;
	IsCleared: boolean;
	IconImage: number;
	UnLocked: boolean;
	...
	IsHidden: boolean;
	UnlockTime: DateTime;
	clone() : SteamAchievements;
	static C(Other: UObject): SteamAchievements;
}

declare class AdvancedSteamAchievementQueryCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode, OutAchievementsArray: SteamAchievements[]) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode, OutAchievementsArray: SteamAchievements[]) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamAchievementQueryCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamAchievementQueryCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamAchievementQueryCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamAchievementQueryCallbackProxy;
	static ReadSteamAchievements(): AdvancedSteamAchievementQueryCallbackProxy;
	static C(Other: UObject): AdvancedSteamAchievementQueryCallbackProxy;
}

declare class AdvancedSteamAchievementsBlueprintLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamAchievementsBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamAchievementsBlueprintLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamAchievementsBlueprintLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamAchievementsBlueprintLibrary;
	static SetProgress(AchievementId: string,StatInfo: SteamStats): boolean;
	static GetCachedAchievement(AchievementId: string,OutAchievement?: SteamAchievements): {OutAchievement: SteamAchievements, $: boolean};
	static GetAchievementIcon(UImage: number): Texture2D;
	static C(Other: UObject): AdvancedSteamAchievementsBlueprintLibrary;
}

declare class AdvancedSteamAchievementUnlockCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamAchievementUnlockCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamAchievementUnlockCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamAchievementUnlockCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamAchievementUnlockCallbackProxy;
	static UnlockSteamAchievement(AchievementId: string): AdvancedSteamAchievementUnlockCallbackProxy;
	static C(Other: UObject): AdvancedSteamAchievementUnlockCallbackProxy;
}

declare class AdvancedSteamCloudDeleteFileCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(FilePath: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(FilePath: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamCloudDeleteFileCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamCloudDeleteFileCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamCloudDeleteFileCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamCloudDeleteFileCallbackProxy;
	static DeleteSteamCloudFile(FilePath: string): AdvancedSteamCloudDeleteFileCallbackProxy;
	static C(Other: UObject): AdvancedSteamCloudDeleteFileCallbackProxy;
}

declare class AdvancedSteamCloudReadFileCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(FilePath: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(FilePath: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamCloudReadFileCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamCloudReadFileCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamCloudReadFileCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamCloudReadFileCallbackProxy;
	static ReadSteamCloudFile(FilePath: string): AdvancedSteamCloudReadFileCallbackProxy;
	static C(Other: UObject): AdvancedSteamCloudReadFileCallbackProxy;
}

declare class AdvancedSteamCloudSharedReadCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(UGCHandle: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(UGCHandle: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamCloudSharedReadCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamCloudSharedReadCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamCloudSharedReadCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamCloudSharedReadCallbackProxy;
	static ReadSteamCloudSharedFile(UGCHandle: string): AdvancedSteamCloudSharedReadCallbackProxy;
	static C(Other: UObject): AdvancedSteamCloudSharedReadCallbackProxy;
}

declare class AdvancedSteamCloudSharedWriteCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(UGCHandle: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(UGCHandle: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamCloudSharedWriteCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamCloudSharedWriteCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamCloudSharedWriteCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamCloudSharedWriteCallbackProxy;
	static WriteSteamCloudSharedFile(LeaderboardName: string,StatName: string,FileName: string,UploadFileList: string[]): AdvancedSteamCloudSharedWriteCallbackProxy;
	static C(Other: UObject): AdvancedSteamCloudSharedWriteCallbackProxy;
}

declare class AdvancedSteamCloudWriteFileCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(FilePath: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(FilePath: string, ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamCloudWriteFileCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamCloudWriteFileCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamCloudWriteFileCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamCloudWriteFileCallbackProxy;
	static WriteSteamCloudFile(FilePath: string): AdvancedSteamCloudWriteFileCallbackProxy;
	static C(Other: UObject): AdvancedSteamCloudWriteFileCallbackProxy;
}

declare type ELeaderboardUploadMethod = string | symbol;
declare var ELeaderboardUploadMethod = { ELeaderboardUploadMethodKeepBest:'ELeaderboardUploadMethodKeepBest',ELeaderboardUploadMethodForceUpdate:'ELeaderboardUploadMethodForceUpdate', };
declare class AdvancedSteamLeaderboardBlueprintLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamLeaderboardBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamLeaderboardBlueprintLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamLeaderboardBlueprintLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamLeaderboardBlueprintLibrary;
	static WriteSteamLeaderboardInteger(LeaderboardUploadMethod: ELeaderboardUploadMethod,LeaderboardName: string,StatName: string,StatValue: number,Details: number[]): boolean;
	static GetAvatarIcon(UImage: number): Texture2D;
	static C(Other: UObject): AdvancedSteamLeaderboardBlueprintLibrary;
}

declare class AdvancedSteamLeaderboardQueryCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(LeaderboardValue: number) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(LeaderboardValue: number) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamLeaderboardQueryCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamLeaderboardQueryCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamLeaderboardQueryCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamLeaderboardQueryCallbackProxy;
	static ReadSteamLeaderboardInteger(LeaboardName: string,StatName: string): AdvancedSteamLeaderboardQueryCallbackProxy;
	static C(Other: UObject): AdvancedSteamLeaderboardQueryCallbackProxy;
}

declare class SteamLeaderboard { 
	PlayerName: string;
	Score: number;
	Rank: number;
	PlayerId: string;
	...
	IconImage: number;
	HandleUGC: string;
	clone() : SteamLeaderboard;
	static C(Other: UObject): SteamLeaderboard;
}

declare type ELeaderboardRequest = string | symbol;
declare var ELeaderboardRequest = { ELeaderboardRequestGlobal:'ELeaderboardRequestGlobal',ELeaderboardRequestGlobalAroundUser:'ELeaderboardRequestGlobalAroundUser',ELeaderboardRequestFriends:'ELeaderboardRequestFriends',ELeaderboardRequestUsers:'ELeaderboardRequestUsers', };
declare class AdvancedSteamLeaderboardRetrieveCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode, PlayerList: SteamLeaderboard[]) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode, PlayerList: SteamLeaderboard[]) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamLeaderboardRetrieveCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamLeaderboardRetrieveCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamLeaderboardRetrieveCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamLeaderboardRetrieveCallbackProxy;
	static RetrieveSteamLeaderboard(LeaboardName: string,StatName: string,StatsArray: SteamStats[],LeaderboardRequest: ELeaderboardRequest,RangeStart: number,RangeEnd: number,DetailCount: number): AdvancedSteamLeaderboardRetrieveCallbackProxy;
	static C(Other: UObject): AdvancedSteamLeaderboardRetrieveCallbackProxy;
}

declare class AdvancedSteamStatsBlueprintLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamStatsBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamStatsBlueprintLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamStatsBlueprintLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamStatsBlueprintLibrary;
	static SetSteamStat(StatsArray: SteamStats[]): boolean;
	static IncreaseSteamStat(StatsArray: SteamStats[]): boolean;
	static GetSteamId(SteamId?: string): {SteamId: string, $: boolean};
	static GetCurrentGameLanguage(): string;
	static C(Other: UObject): AdvancedSteamStatsBlueprintLibrary;
}

declare class AdvancedSteamStatsQueryCallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode, OutStatsArray: SteamStats[]) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode, OutStatsArray: SteamStats[]) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamStatsQueryCallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamStatsQueryCallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamStatsQueryCallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamStatsQueryCallbackProxy;
	static ReadSteamStats(StatsArray: SteamStats[]): AdvancedSteamStatsQueryCallbackProxy;
	static C(Other: UObject): AdvancedSteamStatsQueryCallbackProxy;
}

declare class AdvancedSteamUICallbackProxy extends OnlineBlueprintCallProxyBase { 
	OnSuccess: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode) => void>;
	OnFailure: UnrealEngineMulticastDelegate<(ErrorCode: EAdvancedSteamErrorCode) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdvancedSteamUICallbackProxy;
	static Find(Outer: UObject, ResourceName: string): AdvancedSteamUICallbackProxy;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AdvancedSteamUICallbackProxy;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdvancedSteamUICallbackProxy;
	static ShowWebURL(WebURL: string): AdvancedSteamUICallbackProxy;
	static C(Other: UObject): AdvancedSteamUICallbackProxy;
}

declare class FMODOculusRoomParameters { 
	RoomWidth: number;
	RoomHeight: number;
	RoomDepth: number;
	RefLeft: number;
	...
	RefNear: number;
	RefFar: number;
	clone() : FMODOculusRoomParameters;
	static C(Other: UObject): FMODOculusRoomParameters;
	SetRoomParameters(): void;
	static SetRoomParameters(Params: FMODOculusRoomParameters): void;
}

declare class FMODOculusBlueprintStatics extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODOculusBlueprintStatics;
	static Find(Outer: UObject, ResourceName: string): FMODOculusBlueprintStatics;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODOculusBlueprintStatics;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODOculusBlueprintStatics;
	static SetRoomParameters(Params: FMODOculusRoomParameters): void;
	static SetLateReverberationEnabled(bEnable: boolean): void;
	static SetEarlyReflectionsEnabled(bEnable: boolean): void;
	static C(Other: UObject): FMODOculusBlueprintStatics;
}

declare class FMODOculusSettings extends UObject { 
	bOculusEnabled: boolean;
	bEarlyReflectionsEnabled: boolean;
	bLateReverberationEnabled: boolean;
	RoomParameters: FMODOculusRoomParameters;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODOculusSettings;
	static Find(Outer: UObject, ResourceName: string): FMODOculusSettings;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODOculusSettings;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODOculusSettings;
	static C(Other: UObject): FMODOculusSettings;
}

declare class FMODAmbientSound extends Actor { 
	AudioComponent: FMODAudioComponent;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODAmbientSound;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODAmbientSound;
	static C(Other: UObject): FMODAmbientSound;
}

declare class FMODBank extends FMODAsset { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODBank;
	static Find(Outer: UObject, ResourceName: string): FMODBank;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODBank;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODBank;
	static C(Other: UObject): FMODBank;
	IsBankLoaded(): boolean;
	LoadBank(bBlocking: boolean,bLoadSampleData: boolean): void;
	LoadBankSampleData(): void;
	UnloadBank(): void;
	UnloadBankSampleData(): void;
	static IsBankLoaded(Bank: FMODBank): boolean;
	static LoadBank(Bank: FMODBank,bBlocking: boolean,bLoadSampleData: boolean): void;
	static LoadBankSampleData(Bank: FMODBank): void;
	static UnloadBank(Bank: FMODBank): void;
	static UnloadBankSampleData(Bank: FMODBank): void;
}

declare class FMODBus extends FMODAsset { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODBus;
	static Find(Outer: UObject, ResourceName: string): FMODBus;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODBus;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODBus;
	static C(Other: UObject): FMODBus;
	BusSetMute(bMute: boolean): void;
	BusSetPaused(bPaused: boolean): void;
	BusSetVolume(Volume: number): void;
	static BusSetMute(Bus: FMODBus,bMute: boolean): void;
	static BusSetPaused(Bus: FMODBus,bPaused: boolean): void;
	static BusSetVolume(Bus: FMODBus,Volume: number): void;
}

declare class FMODSnapshot extends FMODEvent { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODSnapshot;
	static Find(Outer: UObject, ResourceName: string): FMODSnapshot;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODSnapshot;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODSnapshot;
	static C(Other: UObject): FMODSnapshot;
}

declare class FMODVCA extends FMODAsset { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODVCA;
	static Find(Outer: UObject, ResourceName: string): FMODVCA;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODVCA;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODVCA;
	static C(Other: UObject): FMODVCA;
	VCASetVolume(Volume: number): void;
	static VCASetVolume(Vca: FMODVCA,Volume: number): void;
}

declare class FMODBlueprintStatics extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODBlueprintStatics;
	static Find(Outer: UObject, ResourceName: string): FMODBlueprintStatics;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODBlueprintStatics;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODBlueprintStatics;
	static VCASetVolume(Vca: FMODVCA,Volume: number): void;
	static UnloadEventSampleData(WorldContextObject: UObject,Event: FMODEvent): void;
	static UnloadBankSampleData(Bank: FMODBank): void;
	static UnloadBank(Bank: FMODBank): void;
	static SetOutputDriverByName(NewDriverName: string): void;
	static SetOutputDriverByIndex(NewDriverIndex: number): void;
	static PlayEventAttached(Event: FMODEvent,AttachToComponent: SceneComponent,AttachPointName: string,Location: Vector,LocationType: EAttachLocation,bStopWhenAttachedToDestroyed: boolean,bAutoPlay: boolean): FMODAudioComponent;
	static PlayEventAtLocation(WorldContextObject: UObject,Event: FMODEvent,Location: Transform,bAutoPlay: boolean): FMODEventInstance;
	static PlayEvent2D(WorldContextObject: UObject,Event: FMODEvent,bAutoPlay: boolean): FMODEventInstance;
	static MixerSuspend(): void;
	static MixerResume(): void;
	static LoadEventSampleData(WorldContextObject: UObject,Event: FMODEvent): void;
	static LoadBankSampleData(Bank: FMODBank): void;
	static LoadBank(Bank: FMODBank,bBlocking: boolean,bLoadSampleData: boolean): void;
	static IsBankLoaded(Bank: FMODBank): boolean;
	static GetOutputDrivers(): string[];
	static FindEventInstances(WorldContextObject: UObject,Event: FMODEvent): FMODEventInstance[];
	static FindEventByName(Name: string): FMODEvent;
	static FindAssetByName(Name: string): FMODAsset;
	static EventInstanceTriggerCue(EventInstance: FMODEventInstance): void;
	static EventInstanceStop(EventInstance: FMODEventInstance): void;
	static EventInstanceSetVolume(EventInstance: FMODEventInstance,Volume: number): void;
	static EventInstanceSetTransform(EventInstance: FMODEventInstance,Location: Transform): void;
	static EventInstanceSetProperty(EventInstance: FMODEventInstance,Property: EFMODEventProperty,Value: number): void;
	static EventInstanceSetPitch(EventInstance: FMODEventInstance,Pitch: number): void;
	static EventInstanceSetPaused(EventInstance: FMODEventInstance,Paused: boolean): void;
	static EventInstanceSetParameter(EventInstance: FMODEventInstance,Name: string,Value: number): void;
	static EventInstancePlay(EventInstance: FMODEventInstance): void;
	static EventInstanceIsValid(EventInstance: FMODEventInstance): boolean;
	static EventInstanceGetParameter(EventInstance: FMODEventInstance,Name: string): number;
	static BusSetVolume(Bus: FMODBus,Volume: number): void;
	static BusSetPaused(Bus: FMODBus,bPaused: boolean): void;
	static BusSetMute(Bus: FMODBus,bMute: boolean): void;
	static C(Other: UObject): FMODBlueprintStatics;
}

declare type EFMODSpeakerMode = string | symbol;
declare var EFMODSpeakerMode = { Stereo:'Stereo',Surround_5_1:'Surround_5_1',Surround_7_1:'Surround_7_1', };
declare class FMODSettings extends UObject { 
	bLoadAllBanks: boolean;
	bLoadAllSampleData: boolean;
	bEnableLiveUpdate: boolean;
	BankOutputDirectory: DirectoryPath;
	OutputFormat: EFMODSpeakerMode;
	bVol0Virtual: boolean;
	Vol0VirtualLevel: number;
	SampleRate: number;
	bMatchHardwareSampleRate: boolean;
	RealChannelCount: number;
	TotalChannelCount: number;
	DSPBufferLength: number;
	DSPBufferCount: number;
	StudioUpdatePeriod: number;
	InitialOutputDriverName: string;
	bLockAllBuses: boolean;
	LiveUpdatePort: number;
	PluginFiles: string[];
	ContentBrowserPrefix: string;
	ForcePlatformName: string;
	MasterBankName: string;
	SkipLoadBankName: string;
	WavWriterPath: string;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODSettings;
	static Find(Outer: UObject, ResourceName: string): FMODSettings;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODSettings;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODSettings;
	static C(Other: UObject): FMODSettings;
}

declare class FMODSnapshotReverb extends ReverbEffect { 
	AssetGuid: Guid;
	bShowAsAsset: boolean;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): FMODSnapshotReverb;
	static Find(Outer: UObject, ResourceName: string): FMODSnapshotReverb;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): FMODSnapshotReverb;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FMODSnapshotReverb;
	static C(Other: UObject): FMODSnapshotReverb;
}

declare class LowEntryCompressionLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryCompressionLibrary;
	static Find(Outer: UObject, ResourceName: string): LowEntryCompressionLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LowEntryCompressionLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryCompressionLibrary;
	static Decompress(CompressedData: number[]): number[];
	static Compress(Data: number[]): number[];
	static C(Other: UObject): LowEntryCompressionLibrary;
}

declare class DemoGameInstance extends GameInstance { 
	GIFCreatorResult: UnrealEngineMulticastDelegate<(Success: boolean, Progress: number) => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): DemoGameInstance;
	static Find(Outer: UObject, ResourceName: string): DemoGameInstance;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): DemoGameInstance;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DemoGameInstance;
	IsThreadFinished(): boolean;
	GetTwitterConsumerSecret(): string;
	GetTwitterConsumerKey(): string;
	GetGifData(GifPath: string,OutData?: number[]): {OutData: number[], $: boolean};
	CreateGif(Width: number,Height: number,FramePerSec: number,TotalFrameCount: number,NFramesToRemove: number,NColors: number,CompressionStrength: number,bByPassCompression: boolean,OutGifPath?: string): {OutGifPath: string, $: boolean};
	CloseGif(): boolean;
	AddGifFrame(GifFrame: TextureRenderTarget2D): boolean;
	static C(Other: UObject): DemoGameInstance;
}

declare class LocalizationMaster extends Actor { 
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LocalizationMaster;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LocalizationMaster;
	SetCurrentCulture(Culture: string,SaveToConfig: boolean): boolean;
	GetCurrentCulture(): string;
	GetComputerCulture(): string;
	static C(Other: UObject): LocalizationMaster;
}

declare class MyClass extends Actor { 
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): MyClass;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MyClass;
	DoSomething(ChunkIndex: number,bInVisible: boolean,TargetMesh: DestructibleComponent): void;
	static C(Other: UObject): MyClass;
}
