...
Set uproject=%~dp0Drift.uproject
Set UATdir="C:\Program Files\Epic Games\UE_4.13\Engine\Build\BatchFiles"

"C:\Program Files (x86)\Epic Games\4.13\Engine\Build\BatchFiles\RunUAT.bat" BuildCookRun -project="%uproject%" -cook -stage -archive -archivedirectory=%builddir% -package -clientconfig=Shipping -ue4exe=UE4Editor-Cmd.exe -pak -prereqs -nodebuginfo -targetplatform=Win64 -build -utf8output
