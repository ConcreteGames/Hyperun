rmdir "C:\Unreal Projects\Rideout\Package" /s /q
...
%UATdir%/RunUAT.bat BuildCookRun -project="%uproject%" -cook -stage -archive -archivedirectory=%builddir% -package -clientconfig=Development -ue4exe=UE4Editor-Cmd.exe -pak -prereqs -nodebuginfo -targetplatform=Win64 -build -utf8output
